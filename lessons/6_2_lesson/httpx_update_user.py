...
response_get_user_by_user_id = httpx.get(f"http://localhost:8000/api/v1/users/{users_response_id}", headers=headers)
print(response_get_user_by_user_id.json())
print(response_get_user_by_user_id.status_code)
...
response_patch = httpx.patch(f"http://localhost:8000/api/v1/users/{users_response_id}", headers=headers, json=users_patch_payload)
